...
public class Main {
  ...
  public void run() {
    try (Scanner scanner = new Scanner(System.in)) {
      do {
        play();
        System.out.printf("Wins: %d; Losses: %d.%nPlay again?", game.getWins(), game.getLosses());
  ...
  public void run(int trials) {
    ...
    System.out.printf("Wins: %d; Losses: %d.%nWinnig percentage = %f%%.%n", wins, losses, winPercent);
  }
